...
@Schema(description = "DTO representing a product review")
public class ReviewDto {
    ...
    private String username; // Yorumu yapanın kullanıcı adını göstermek iyi olur
    ...
    public ReviewDto(Long id, Long productId, Long userId, String username, Integer rating, String comment, LocalDateTime reviewDate) {
        this.id = id;
